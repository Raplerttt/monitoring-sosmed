...
const MyOrder = ({ongoing, completed, canceled}) => {
  return (
    <div className="relative shadow-lg rounded-2xl bg-red-400/70 p-6 text-black">
      <div className="flex items-center space-x-4">
        <button
          type="button"
          className="w-10 h-10 flex items-center justify-center rounded-full bg-light-blue/50 text-light border-none"
        >
      ...
      <div className="flex justify-start mt-6 gap-10" id="stack-order-summary">
        <div className="text-center">
          <p className="text-lg font-semibold text-black order-ongoing">{ongoing}</p>
          <small className="text-black opacity-50">Ongoing</small>
        </div>
        <div className="text-center">
          <p className="text-lg font-semibold text-black order-completed">{completed}</p>
          <small className="text-black opacity-50">Completed</small>
        </div>
        <div className="text-center">
          <p className="text-lg font-semibold text-black order-canceled">{canceled}</p>
